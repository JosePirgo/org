  ...
  return (
...

    {
      equipos.map((equipo) => <Equipo 
        datos={equipo} 
        key={equipo.titulo}
        colaboradores={colaboradores.filter(colaborador=>colaborador.equipo === equipo.titulo)} /*key={equipo.titulo} SE TRABAJA CUANDO SE USA MAP , PARA Q TENGA UN REFERENCIA */
